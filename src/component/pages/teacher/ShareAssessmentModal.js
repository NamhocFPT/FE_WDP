                            ...
                            {isFetching ? (
                                ...
                                classes.map(c => {
                                    ...
                                    return (
                                        <div 
                                            key={c.id} 
                                            onClick={() => !isAlreadyShared && handleToggleClass(c.id)}
                                            className={`flex items-center justify-between p-3 rounded-xl border-2 transition-all 
                                                ${isAlreadyShared ? 'border-slate-100 bg-slate-50 opacity-60 cursor-not-allowed' : 
                                            ...
                                            title={isAlreadyShared ? "Đã được chia sẻ tới lớp này" : ""}
                                        >
