...
export function SearchableSelect({ options, value, onChange, placeholder = "Search..." }) {
    ...
    return (
        <div ref={wrapperRef} className="relative w-full">
            ...
            />
            {isOpen && (
                <div className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-slate-200 bg-white py-1 shadow-lg shadow-slate-200/50">
                        ...
                        filteredOptions.map((opt) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    value === opt.value ? "bg-slate-50 font-medium text-blue-600" : "text-slate-700"
                                )}
                                onClick={() => {
                                    onChange(opt.value);
                                    setIsOpen(false);
